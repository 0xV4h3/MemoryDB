...
internal static class BinaryPayloadCodec
{
    ...
    private static void WriteValue(BinaryWriter writer, object? value, Type declaredType)
    {
    ...
    private static void WriteCollection(BinaryWriter writer, IEnumerable value, Type elementType)
    {
    ...
    private static void WriteNested(BinaryWriter writer, object value)
    {
    ...
    private static object ReadCollection(BinaryReader reader, bool isArray, Type elementType)
    {
    ...
    private static Array ReadArray(BinaryReader reader, Type elementType, int count)
    {
    ...
    private static object ReadList(BinaryReader reader, Type elementType, int count)
    {
    ...
    private static object ReadNested(BinaryReader reader, Type type)
    {
